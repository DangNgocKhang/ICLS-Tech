  ...
  return (
    <section className="flex flex-col grow shrink justify-center self-stretch px-5 py-9 my-auto bg-white border border-primary-blue-lighter border-solid min-h-[217px] min-w-[240px] w-full">
      <div className="flex flex-col w-full">
        <div className="flex gap-5 items-center self-center text-5xl font-bold text-primary-blue-lighter whitespace-nowrap max-md:text-4xl">
          {
        ...
        <p className="mt-3 text-lg leading-8 text-center text-black">
          {description}
        </p>
      </div>
    </section>
