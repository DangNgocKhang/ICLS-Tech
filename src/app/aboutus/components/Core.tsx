...
const Core = () => {
  return (
    <div className="px-6 md:px-10 py-10 md:py-20 bg-primary-blue-lighter">
      <h1 className="text-6xl font-bold text-white max-md:max-w-full max-md:text-4xl text-center uppercase">
        Giá trị cốt lõi
      </h1>
      <div className="flex flex-col md:flex-row mt-6 gap-5">
        <div className="h-max overflow-hidden p-5 flex-1 bg-white bg-opacity-25 border-2 rounded-3xl text-white flex flex-col gap-5">
          <h4 className="text-xl font-bold">Sự Tiên Phong</h4>
