...
const Header = () => {
  const [isRegisterFormsOpen, setRegisterFormsOpen] = useState(false);

  const openRegisterForms = () => setRegisterFormsOpen(true);
  const closeRegisterForms = () => setRegisterFormsOpen(false);
  ...
  return (
    <>
      ...
      {<RegisterForms isRegisterFormsOpen={isRegisterFormsOpen} closeRegisterForms={closeRegisterForms} />}
    </>
  );
};
